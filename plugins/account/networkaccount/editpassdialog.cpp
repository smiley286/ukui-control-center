...
EditPassDialog::EditPassDialog(QWidget *parent) : QWidget(parent)
{
    ...
    confirm_pass = new QLineEdit(this);
    ...
    QRegExp regx("^[a-zA-Z0-9_-]{4,30}$");
    QValidator *validator = new QRegExpValidator(regx, account );
